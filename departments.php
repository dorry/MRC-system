      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <a href="departments.html">Radiology</a>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-lg-12">
            <div class="department-slider owl-carousel">
              <div class="single-slide">
                <div class="slide-img">
                  <img
                    src="assets/images/department1.jpg"
                    alt=""
                    class="img-fluid"
                  />
              ...
              <div class="single-slide">
                <div class="slide-img">
                  <img
                    src="assets/images/department2.jpg"
                    alt=""
                    class="img-fluid"
                  />
                  <div class="hover-state">
              ...
              <div class="single-slide">
                <div class="slide-img">
                  <img
                    src="assets/images/department3.jpg"
                    alt=""
                    class="img-fluid"
                  />
                  <div class="hover-state">
